...
export const GameControls = defineComponent<void, GameControlsProps>({
  ...
  render(this: IComponent<any, GameControlsProps>) {
    ...
    [...pauseButtonBaseClasse,"ring-2", "ring-[var(--light-yellow)]", "outline-none", "hover:bg-[var(--darker-grey)]"] :
    [...pauseButtonBaseClasse,"focus:outline-none", "focus:ring-0", "hover:bg-[var(--darker-grey)]"]
